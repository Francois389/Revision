...
<html lang="fr">
    ...
    <div class="container">
        <form method="post" action="index.php?controller=CreationCarte&action=creation">
            ...
            <div class="container-description <?php if (!$descriptionInfo["valide"]) echo "erreur" ?>">
                <label for="description">Description</label>
                <textarea type="text" name="description"
                          placeholder="Description de la Carte"><?php echo $descriptionInfo["valeur"] ?></textarea>
            </div>

            <div class="container-tag <?php if (!$tagInfo["valide"]) echo "erreur" ?>">
            ...
            <div class="container-echeance <?php if (!$echeanceInfo["valide"]) echo "erreur" ?>">
                <label for="echeance">&Eacute;ch&eacute;ance</label>
                <input type="date" name="echeance" value="<?php echo $echeanceInfo["valeur"] ?>">
            </div>

            <div class="container-importance <?php if (!$importanceInfo["valide"]) echo "erreur" ?>">
